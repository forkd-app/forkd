...
export type RequestMagicLinkMutation = {
  __typename?: "Mutation"
  user?: { __typename?: "UserMutation"; requestMagicLink: string } | null
}
...
export function getSdk(
  ...
  return {
    ...
    RequestMagicLink(
      variables: RequestMagicLinkMutationVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<RequestMagicLinkMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<RequestMagicLinkMutation>(
